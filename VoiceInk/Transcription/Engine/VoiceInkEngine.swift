...
class VoiceInkEngine: NSObject, ObservableObject {
    ...
    private var activeRecordingOutputTextCase: OutputTextCaseMode = .normal
    private var activePipelineOutputTextCase: OutputTextCaseMode = .normal
    ...
    func toggleRecord(
        ...
        outputTextCase: OutputTextCaseMode = .normal
    ) async {
        ...
        if recordingState == .recording {
            ...
            activePipelineOutputTextCase = activeRecordingOutputTextCase
            activeRecordingUseCase = .newSession
            activeRecordingOutputTextCase = .normal
            ...
            activeRecordingOutputTextCase = outputTextCase
    ...
    private func runPipeline(
        ...
        await pipeline.run(
            ...
            session: session,
            outputTextCase: activePipelineOutputTextCase,
        ...
        if didFinishActivePipeline {
            ...
            shouldCancelRecording = false
            activePipelineUseCase = .newSession
            activePipelineOutputTextCase = .normal
            clearActiveRecordingContext()
        }
